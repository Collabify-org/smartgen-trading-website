              ...
              {images.map((filename) => (
                ...
                >
                  <img
                    ...
                    className="w-full aspect-square object-cover bg-gray-100 group-hover:scale-110 transition-transform duration-300"
                    loading="lazy"
                    onError={(e) => {
        ...
        <div className="bg-gradient-to-r from-primary to-accent rounded-3xl p-10 lg:p-12 text-white text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl sm:text-4xl font-extrabold mb-4">
              Interested in {productData.title}?
            </h2>
            <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
              Contact us for quotes, bulk pricing, and product specifications. We offer special prices for large orders.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 bg-white text-primary px-8 py-4 rounded-xl font-bold hover:shadow-xl transition-all hover:scale-105 transform"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white px-8 py-4 rounded-xl font-bold hover:bg-white/20 transition-all"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
